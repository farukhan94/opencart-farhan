...
class __TwigTemplate_82935c82fbea09b5f3d4e8500accfcfc5c1a17b5f2d47ec26cc9e5022ce70b37 extends \Twig\Template
{
    private $source;
    private $macros = [];
  ...
  ";
    ...
    <div id=\"segment-slider-";
            ...
            echo "\" class=\"owl-carousel segment-carousel\" style=\"display: flex; overflow: hidden;\">
      ";
            // line 6
            $context['_parent'] = $context;
  ...
  function initSegmentCarousel";
      ...
      if (typeof \$el.owlCarousel === 'function') {
          ...
          setTimeout(initSegmentCarousel";
            // line 51
            echo twig_get_attribute($this->env, $this->source, $context["slider"], "slider_id", [], "any", false, false, false, 51);
            echo ", 100);
      }
  }
  \$(document).ready(initSegmentCarousel";
            // line 54
            echo twig_get_attribute($this->env, $this->source, $context["slider"], "slider_id", [], "any", false, false, false, 54);
            echo ");
  --></script>
  ";
        }
...
";
    ...
    {
        return array (  166 => 57,  157 => 54,  151 => 51,  131 => 34,  127 => 33,  122 => 30,  112 => 25,  108 => 23,  100 => 21,  94 => 19,  92 => 18,  89 => 17,  87 => 16,  83 => 15,  77 => 14,  65 => 11,  59 => 7,  55 => 6,  51 => 5,  47 => 4,  44 => 3,  40 => 2,  37 => 1,);
    }
