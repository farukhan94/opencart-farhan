...
class __TwigTemplate_4130a1634f70e7555cfb22e0c5f0091c604140b2c1de6a0659a4c6701b8b18a3 extends \Twig\Template
{
    private $source;
    private $macros = [];
    ...
    <div class=\"modal-content\">
      ...
      <div class=\"modal-body\">
        ...
        foreach ($context['_seq'] as $context["_key"] => $context["group"]) {
            // line 245
            echo "                 <option value=\"";
            echo twig_get_attribute($this->env, $this->source, $context["group"], "customer_group_id", [], "any", false, false, false, 245);
            echo "\">";
            echo twig_get_attribute($this->env, $this->source, $context["group"], "name", [], "any", false, false, false, 245);
            echo "</option>
                 ";
        }
        $_parent = $context['_parent'];
        ...
        echo "</option>
           ...
           <fieldset>
             ...
             <div class=\"col-sm-9 col-sm-offset-3\">
                <span class=\"help-block\">If defined, a Firebase push notification is sent immediately when a user hits this rule.</span>
             </div>
           </fieldset>
        </form>
      </div>
