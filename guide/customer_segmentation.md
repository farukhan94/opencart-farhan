...
![Admin General & Firebase](imgs/admin_general_firebase.png)
...
![Admin Logs](imgs/admin_logs.png)
...
![Admin Rules List](imgs/admin_rules_list.png)
...
![Admin Bulk Rebuild](imgs/admin_bulk_rebuild.png)

### Rule Configuration
Each rule consists of **Triggers**, **Conditions**, and **Actions**.

![Admin Rule Edit](imgs/admin_rule_edit.png)
...
![Admin Mock App](imgs/admin_mock_app.png)
...
![Admin Banners Management](imgs/admin_banners.png)
![Admin Sliders Management](imgs/admin_sliders.png)
![Admin Promotions Management](imgs/admin_promotions.png)
...
For a complete walkthrough on deploying this project to a fresh Contabo VPS using Docker, see the dedicated **[SERVER_DEPLOYMENT.md](file:///c:/Users/Admin/Downloads/opencart-3.0.3.8/guide/SERVER_DEPLOYMENT.md)** file.
